  ...
  window,
	{
		"nol_GLOBALS":{
			...
			"nol_osGroup":"",
			"nol_platform":"",
			"nol_clientid":"us-700144","nol_vcid":"c10","nol_dayoffset":"0","nol_clientCMSmap":{"nol_crossRefID1":"crossId1","nol_vcid":"subbrand","nol_adobeId":"adobeId","nol_clientid":"clientid","nol_vidtype":"type","nol_stationType":"stationType","nol_length":"length","nol_title":"(title)","nol_cref3":"cref3","nol_stationId":"stationId","nol_airDate":"(airdate)","nol_segmentC":"(segC)","nol_ottType":"(ottType)","nol_category":"(program)","nol_mediaURL":"(mediaURL)","nol_scheduledEndDate":"((scheduledEndDate))","nol_reportSuiteID":"(reportSuite)","nol_assetid":"assetid","nol_adSupportFlg":"hasAds","nol_assetName":"(section)","nol_segmentB":"(segB)","nol_segmentA":"(segA)","nol_crossRefID2":"crossId2","nol_isFullEpisode":"isfullepisode","nol_isAudio":"false","nol_ottStatus":"ottStatus","nol_adLoadType":"adloadtype","nol_progen":"progen","nol_adobeSessionId":"adobeVsid","nol_adsupportoverride":"1"},"nol_sfcode":"dcr",
			"nol_cidOffsetNull":"00000",
			"nol_emmsfcodelist":["eu","eu-cert","eu-uat","pl","pl-cert","cert","qat4","us","dcr","sdk","dcr-cert","au","it","dmk","sw","ire","twn"],
